...
public class DefaultPersonService implements StudentService {
    private final StudentRepository studentRepository;
    private final PersonRepository personRepository;

    public DefaultPersonService(StudentRepository studentRepository, PersonRepository personRepository) {
